...
cap = cv2.VideoCapture("Video/20180725_1320.mp4")
frame = 1
...
while frame is not None:
    ...
    cv2.line(blank_image, (INITIAL + GRID_WIDTH * 4, 10), (INITIAL + GRID_WIDTH * 4, b_height - PADDING), (0, 0, 0), 1)
    cv2.line(blank_image, (INITIAL + GRID_WIDTH * 5, 10), (INITIAL + GRID_WIDTH * 3, b_height - PADDING), (0, 0, 0), 1)
    cv2.line(blank_image, (INITIAL + GRID_WIDTH * 6, 10), (INITIAL + GRID_WIDTH * 3, b_height - PADDING), (0, 0, 0), 1)
